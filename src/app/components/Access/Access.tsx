...
export default function Access() {
  return (
    <section className='px-[5.3%] mt-[49px] md:mt-[100px] pb-[34px] md:pb-[100px]'>
    ...
    <div className='flex flex-col md:flex-row md:mt-[133px]'>  
    <dl className='order-2 md:order-1 md:flex-1 '>
