...
export default function Access() {
  return (
    ...
    <div className='contents md:block'>
      <h2 className={`${oswald.className} rotate-[0.03deg] text-[clamp(6.4rem,10vw,22.1rem)] text-transparent font-bold leading-[100%] [-webkit-text-stroke-width:1px] [-webkit-text-stroke-color:#F5F5F5]`} id='access'>ACCESS</h2>
