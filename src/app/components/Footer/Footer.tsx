  ...
  return (
    <footer className='mt-[49px] mb-[12px] px-[5.3%] md:px-0'>
     ...
     `}>
            ...
            <li><Link href='' aria-label='ABOUTMEページへ移動' className='whitespace-nowrap'>ABOUT ME</Link></li>
      ...
      <div className={`${oswald.className} text-[clamp(5.7rem,16.2vw,23.3rem)] mt-[18px] font-bold whitespace-nowrap leading-[100%] text-transparent [-webkit-text-stroke-width:1px] [-webkit-text-stroke-color:#F5F5F5] md:px-[1.1%]`}>KYOSUKE SATO</div>
