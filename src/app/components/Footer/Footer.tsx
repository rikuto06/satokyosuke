...
export default function Footer() {
  return (
    <footer className='mt-[49px] mb-[12px] px-[5.3%]'>
      <nav>
     <ul className={`${oswald.className} grid grid-cols-2 text-[1.4rem] font-bold leading-normal text-[#F5F5F5]`}>
      ...
      <div className={`${oswald.className} mt-[18px] text-[5.7rem] font-bold whitespace-nowrap leading-[100%] text-transparent [-webkit-text-stroke-width:1px] [-webkit-text-stroke-color:#F5F5F5]`}>KYOSUKE SATO</div>
