...
export default function Menu() {
  ...
  return (
    <section className='px-[5.3%] pt-[49px] pb-[49px] md:px-0 md:pt-[100px] md:pb-[200px] sticky top-0  bg-[#0D0D0D]' id='menu'>
      <ScrollFade>
      <h2 className={`${oswald.className} rotate-[0.03deg] rotate-[0.03deg] text-[clamp(6.4rem,10vw,22.1rem)] text-transparent font-bold leading-[100%] [-webkit-text-stroke-width:1px] [-webkit-text-stroke-color:#F5F5F5] md:ml-[5.3%]`}>MENU</h2>
      </ScrollFade>
