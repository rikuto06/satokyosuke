...
() {
  return (
    ...
    `}>TO ALL</p><p className={`${oswald.className} absolute top-[4.3rem] left-[5.3%] text-transparent text-[6.5rem] font-bold leading-[100%] [-webkit-text-stroke-width:1px] [-webkit-text-stroke-color:#F5F5F5]
